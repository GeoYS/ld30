...
public class Images {
	...
	static {
		WORKER_LEFTUP = new Texture(new Pixmap(Gdx.files.internal("../LD30/res/worker_sprite_1.png")));
		WORKER_DOWNRIGHT = new Texture(new Pixmap(Gdx.files.internal("../LD30/res/worker_sprite_2.png")));
